...
window.App = {
    init: function () {
        KTCOffer = web3.eth.Contract(ABI).at('address');
    },

    BuyOfferContract: function (Offerer, NumberOfDays, OfferAmount, ShareNumber, Offers, Currency) {
        Asset.BuyOfferContract(Position, (error, result) => {
            console.log(result)
        })
    },    

    SellOfferContract: function (Address) {
